...
from hls4ml.converters.utils import parse_data_format, compute_padding_1d, compute_padding_2d, compute_padding_1d_transpose, compute_padding_2d_transpose
...
def parse_cond1dtranspose_layer(keras_layer, input_names, input_shapes, data_reader, config):
...
def parse_conv2dtranspose_layer(keras_layer, input_names, input_shapes, data_reader, config):
